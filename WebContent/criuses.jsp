...
<html>
    ...
    var data = {"businesses":<%= request.getAttribute("jsonArray") %> };    /* retrieve json from request attribute */
				var len= data.businesses.length;
				for(var i=0;i<len;i++){
					var parent=document.getElementById("criuse-grids");
					var elem= document.createElement("div");
					elem.className="criuse-grid";
					elem.innerHTML= '<div class="criuse-grid-head"><div class="criuse-img"><div class="criuse-pic">'+
					'<img src="'+data.businesses[i].image_url+'" title="criuse-name" /> </div></div> '+
					'<div class="criuse-info"><div class="criuse-info-left"><ul><li><a class="c-hotel" href="#"><span> </span>'+data.businesses[i].name+' </a></li>'+
					'<div class="clear"> </div></ul></div><div class="clear"> </div></div></div><div class="criuse-grid-info"><h1><a href="#">'+data.businesses[i].name+'</a></h1>'+
					'<p>'+data.businesses[i].location.address+'</p><a class="btn" href="'+data.businesses[i].url+'">DeTails</a></div>';
		...
		<div class="criuses">
			<div class="criuses-head">
				...
				<div class="criuse-main">
					<div class="wrap">
						<div class="criuse-grids" id="criuse-grids">
